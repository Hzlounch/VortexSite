/* ==========================================================================
   VORTEXLAUNCHER — MULTI-LANGUAGE TRANSLATION ENGINE (EN, TR, PL)
   ========================================================================== */
...
const VORTEX_TRANSLATIONS = {
  en: {
    ...
    support_a2: "Yes! VortexLauncher is 100% free to download and play with all core performance mods enabled.",
  ...
  tr: {
    ...
    support_a2: "Evet! VortexLauncher'ı indirmek ve tüm temel performans modlarıyla oynamak %100 ücretsizdir.",
  ...
  pl: {
    ...
    support_a2: "Tak! VortexLauncher jest w 100% darmowy do pobrania i grania ze wszystkimi modami wydajnościowymi.",
...
window.VortexI18n = {
  currentLang: localStorage.getItem('vortex_lang') || 'en',
  ...
  setLanguage(lang) {
    if (!VORTEX_TRANSLATIONS[lang]) lang = 'en';
